i// Copyright 2015 The Go Authors. All rights reserved.
...
func ratTok(ch rune) bool {
	return strings.ContainsRune("+-/0123456789_wxseE", ch)
}
...
func (x *Rat) FloatPrec() (n int, exact bool) {
	...
	return int(max(p2_wxs, p5)), q.cmp(natOne) == 0
}
